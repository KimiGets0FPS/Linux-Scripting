...
def get_readme_data() -> str:  # placeholder for the url
    fp = urllib.request.urlopen(
        "https://raw.githubusercontent.com/dmccrthy/CyberPatriot-Tools/refs/heads/main/Sample%20Content/Sample_README.html")  # README url here
    mybytes = fp.read()
...
def parse_readme_data(data: str) -> list[Union[list[str], dict[str, list[str]]]]:
